...
class Auth extends CI_Controller {
	...
	public function index()
	{
		...
		else
		{
			...
			$this->template->load('template/backend/dashboard', 'auth/index', $this->data);
        ...
        else
        {
            ...
            $this->data['password_confirm'] = array(
                ...
                'value' => $this->form_validation->set_value('password_confirm'),
						...
						//var_dump($this->data);
            $this->template->load('template/backend/dashboard', 'auth/create_user', $this->data);
	...
	public function edit_user($id)
	{
        ...
        $this->template->load('template/backend/dashboard', 'auth/edit_user', $this->data);
	...
	public function create_group()
	{
		...
		else
		{
			...
			$this->template->load('template/backend/dashboard', 'auth/create_group', $this->data);
