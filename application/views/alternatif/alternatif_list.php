        ...
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $alternatif->nama_karyawan ?></td>
                    <td><?php echo $alternatif->alamat_karyawan ?></td>
                    <td><?php echo $alternatif->status ?></td>
                    <td style="text-align:center" width="200px">
                        <?= anchor('Alternatif/update/'.$alternatif->id_alternatif, 'Update',array('class'=>'btn btn-default btn-sm')); ?>
                        <?= "|" ?>
