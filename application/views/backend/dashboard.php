		    <div class="row">
	        	...
	        	<div class="col-sm-3">
	        		...
	        		<div class="tile-stats tile-aqua">
	        			...
	        			<div class="num" data-start="0" data-end=" <?php echo count($jumlah_karyawan) ?> " data-postfix="" data-duration="1500" data-delay="1200">0</div>
	        			
	        			<h3>Jumlah Karyawan</h3>
	        			<p>Karyawan yang ada di kota makassar.</p>
	        		</div>
	        ...
	        <div class="row">
				...
				<div class="col-md-6">
					...
					<div class="panel panel-success" data-collapsed="0">
						...
						<!-- panel head -->
						<div class="panel-heading">
							<div class="panel-title">SPK Penentuan Karyawan Unggulan</div>
							<div class="panel-options">								
								<a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
								<a href="#" data-rel="reload"><i class="entypo-arrows-ccw"></i></a>
							</div>
						...
						<!-- panel body -->
						<div class="panel-body" style="text-align: justify;">
							<p>Sistem Pendukung Keputusan Penentuan Karyawan Unggulan Tingkat SMA Sederajat Menggunakan Metode Analytical Hierarchy Process 
							adalah sebuah sistem yang bertujuan untuk menentukan Karyawan-karyawan yang ada di makassar sebagai karyawan unggulan.
							Tentu output atau keluaran dari sistem ini hanya sebagai rekomendasi dan perbandingan saja karena
							untuk pemberian nama karyawan unggulan tentu merupakan hak dan wewenang Pemerintah dalam hal ini Dinas Pendidikan
							dimana karyawan tersebut memiliki beberapa kriteria yang akan menentukan bahwa karyawan tersebut bisa dikatakan sebagai karyawan unggulan.
