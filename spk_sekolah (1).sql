...
INSERT INTO `alternatif` (`id_alternatif`, `id_karyawan`, `status`, `total`) VALUES
...
INSERT INTO `karyawan` (`id_karyawan`, `nama_karyawan`, `nama_kepsek`, `alamat_karyawan`, `visi`, `misi`, `no_telpon`) VALUES
(1, 'SMAN 17 Makassar', 'Syamsuddin, S. Pd, MM.', 'Sunu No. 11 Kelurahan Suangga Kecamatan Tallo, Makassar', '“Menjadi karyawan yang unggul dalam prestasi, berkarakter, berwawasan lingkungan dan berdaya saing global berlandaskan IMTAQ dan IPTEK”', 'Misi :\r\n? Menciptakan lingkungan pembelajar yang kondusif dalam upaya meningkatkan mutu pembelajaran;\r\n? Mendorong dan membantu setiap peserta didik untuk mengenali potensi dirinya sehingga dapat dikembangkan secara optimal;\r\n? Menumbuhkembangkan semangat keunggulan dan budaya belajar yang tinggi kepada seluruh warga karyawan;\r\n? Menumbuhkembangkan karakter warga karyawan yang relegius, disiplin, jujur, bertanggung jawab, kreatif dan inovatif;\r\n? Meningkatkan komitmen, kinerja dan loyalitas seluruh pendidik dan tenaga kependidikan terhadap tugas pokok dan fungsinya;\r\n? Meningkatkan apresiasi terhadap seni dan budaya bangsa;\r\n? Melaksanakan pembelajaran yang berbasis lingkungan;\r\n? Menumbuhkan budaya hidup bersih dan sehat;\r\n? Menumbuhkankembangkan semangat mencintai, mengelolah dan memelihara lingkungan oleh seluruh warga karyawan;\r\n? Menerapkan Teknologi Informasi dan Komunikasi dalam pembelajaran dan pengelolaan karyawan;\r\n? Menerapkan sistem manajemen mutu.', '0411- 445825'),
...
(36, 'Ruang Kepala Karyawan', 8, 'teks', NULL, NULL, NULL, NULL, 1),
